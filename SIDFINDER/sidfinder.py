...
_______________________________________________________________     
   _____ _____ _____  ______ _____ _   _ _____  ______ _____  
  / ____|_   _|  __ \|  ____|_   _| \ | |  __ \|  ____|  __ \ 
 | (___   | | | |  | | |__    | | |  \| | |  | | |__  | |__) |
  \___ \  | | | |  | |  __|   | | | . ` | |  | |  __| |  _  / 
  ____) |_| |_| |__| | |     _| |_| |\  | |__| | |____| | \ \ 
 |_____/|_____|_____/|_|    |_____|_| \_|_____/|______|_|  \_\
...
if len(sys.argv) < 2:
    print("\n'python3 sidfinder.py -h' for help ")
    sys.exit(1)
...
if len(sys.argv) < 3:
    print("\nMissing argument. Help: 'python3 sidfinder.py -h'")
    sys.exit(1)
...
_______________________________________________________________                                                                                                                                
    """"")
    print("Starting...")
    print("\nTry to find Sensitive Information Disclosure In ='",input_value,"'  URL from the source code")
...
_______________________________________________________________                                                                                                                                 
    """"")
    print("Starting...")
    print("\nReading the urls in the text file and adding the http:// tag if missing")
    print("\nTry to find Sensitive Information Disclosure in URL's given in the text file")
